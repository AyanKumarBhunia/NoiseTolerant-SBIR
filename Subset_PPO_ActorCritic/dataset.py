...
def collate_self_Train(batch):
    ...
    for i_batch in batch:
        ...
        batch_mod['sketch_vector'].append(torch.tensor(i_batch['sketch_vector']))
    ...
    batch_mod['sketch_vector'] = pad_sequence(batch_mod['sketch_vector'], batch_first=True)
    batch_mod['every_stroke_len'] = torch.tensor(batch_mod['every_stroke_len'])
    batch_mod['stroke_wise_split'] = pad_sequence(batch_mod['stroke_wise_split'], batch_first=True)
...
def get_dataloader(hp):
    ...
    if torch.cuda.is_available():
        ...
        dataloader_Train = data.DataLoader(dataset_Train, batch_size=hp.batchsize, shuffle=True, collate_fn=collate_self_Train)
